...
st.subheader("This is a simple program to create a plot of the Central Limit Theorem with the exponential distribution")
st.write(('This app simulates a thousands of input below,'  
